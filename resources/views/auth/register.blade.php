...
<head>
    ...
    <title> @lang('messages.Sign Up') </title>
    <meta name="keywords"
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto align-self-center mmff">
                                <a href="{{ route('login') }}" class="menu-btn">
                                    ...
                                    <div class="mb-text"> @lang('messages.Sign In')</div>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 align-self-center">
                            ...
                            <div class="head-links row mt-5">
                                ...
                                <div class="col-auto">
                                    <a href="{{ route('login') }}" class="btn btn-outline btn-lg">@lang('messages.Sign In')
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <form action="{{ route('register') }}" method="post">
                                            ...
                                            <div class="login-form mt-5 py-3">
                                                ...
                                                <div class="fg fg-light mb-4">
                                                    ...
                                                    <input type="text" class="fg-control" id="name"
                                                        value="" name="name"
                                                ...
                                                <div class="fg fg-light mb-4">
                                                    ...
                                                    <input type="password" class="fg-control" id="password"
                                                        name="password" placeholder="@lang('messages.Password')">
                                                </div>
                                                ...
                                                {{-- <div class="form-group">
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="accept_terms_text"
                                                            class="terms-accept-checkbox"
                                                            name="RegistrationForm[termsofservice]">
                                                        <label class="checkbox" for="accept_terms_text">
                                                            I have read and agreed with <a href=""
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col-md-12 mb-5 mb-md-0">
                                                        <button type="submit"
                                                            ...
                                                            @lang('messages.Sign Up')</button>
                                                    </div>
                                                </div>
                                                <div class="btn btn-dark btn-block mt-3">
                                                    @lang('messages.Already have an account') <a
                                                        href="{{ route('login') }}">@lang('messages.Sign In')
                                                    </a>
                                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-top">
                        <div class="row align-items-center">
                            <div class="col-lg-7">
                                <h1> @lang('messages.Already have an account')</h1>
                            </div>
